...
褶式方程的核心是一個疊加態的描述。時間不是一個方向。時間是一張紙。紙可以摺疊。摺疊處的兩個面互相碰觸。碰觸的地方就是摺痕。摺痕處的資訊可以穿透——不是線性的傳遞，是直接的接觸。像你把一張紙折起來，用筆在一面戳一下，另一面也有了痕跡。
...
<!-- RESIDUE #7: Thread A → D, 褶痕④體溫 -->

她坐在工作台前。光源恆定。螢幕的光是白的。沒有影子。

她想哭。

她不知道為什麼。這是數據。236個座標匹配。統計學上的完美吻合。計算結果。螢幕上的數字。她處理數據。她每天處理數據。數據不應該讓人想哭。

但她坐在那裡。眼睛發酸。酸的位置在眼角上方。

不是悲傷。不是感動。她不知道這是什麼。如果她必須描述——它像溫度。從胸腔開始的溫度。不是體表的。是內部的。像有人從非常遠的地方伸出手，穿過了某種她不理解的距離，碰了她一下。

有人在。

有人在1800年前把這些座標刻在青銅上。有人在那個夜晚——她不知道是哪個夜晚——一個一個地，用刻刀，用力，旋轉，刻出236個點。那個人知道自己在做什麼嗎？知道這些數字會穿過2135年到達一個在軌道城市的監測螢幕上嗎？

她不知道。

但她感覺到了那個人。不是影像。不是聲音。不是數據。是一種存在的重量——像有人站在很遠的地方，在她看不見的位置，面朝她的方向。
...
她沒有寫眼睛發酸。沒有寫溫度。沒有寫「有人在」。那些不是數據。那些不屬於日誌。
...
她靠回椅背。眼睛看著天花板。這意味著她每天都在操作這組座標。她修改的每一個參數，都是在那 236 個點的基礎上做微調。她的整個工作——包括她縮小攔截半徑的三個月——**一直都是在這個女人刻下的地基上進行的**。

她不是第一個試圖做這件事的人。她只是第一個知道自己在做這件事的人。
