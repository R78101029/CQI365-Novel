<!-- 來源：https://github.com/OpenRouterTeam/skills/tree/main/skills/openrouter-video
     OpenRouter 官方 skill，2026-08-23 取回，內容未改。
     本管線用 Node 腳本而非 curl+jq（Windows 沒有 jq），但參數與流程以本文件為準。 -->
