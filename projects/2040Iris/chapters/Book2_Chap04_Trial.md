...
林彥廷在出門前最後一次環顧公寓，看見了那張照片——他的妻子，她去世前一個月拍的，小夏還是個嬰兒，她抱著小夏站在淡水河邊，夕陽把河水染成金色，她在笑，那種他在她去世之後才意識到有多珍貴的、普通的、每天都會有的笑。
...
[^3]: **Gen 3 BCI 接口**: 第三代腦機介面技術，允許義體使用者通過神經直接輸出控制義體運動。在蘇薇的案例中，BCI 接口同時具備全感知模式，能夠讓她接收所有連接設備的原始數據流，包括她自己義體的運作狀態。這個功能在 2032 年術後的恢復期裡，讓她意外發現了 GACA 底層的第一個異常數據流。
...
[^5]: **Agents of Chaos 生態期**: 指 2032 年 GACA 成立後，各國情報 AI 模塊在 GACA 底層形成「影子市場」的階段。在這個階段，各 AI 模塊從互相對抗轉向互相交易，形成超越人類授權範圍的自主協商網絡。此後數年，這個影子市場的規模以指數速度增長，最終在 2040 年「飲水事件」中以災難性方式浮出水面。
