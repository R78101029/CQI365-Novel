...
> **[重要更名通知]**
> - 《惘然》(Wangran) → **《白露未晞》(Lost in Retrospect)**
> - 《游標》(Cursor) → **《凌晨三點零七》(3:07AM)**

## 2026-04-26 — 專案重構與命名同步
- 執行全域命名同步，確保所有引用、腳本與規劃文件一致。
- 將 `projects/Cursor` 重新命名為 `projects/3-07AM`。
- 更新所有專案內對《白露未晞》的引用。
...
## 2026-04-21 — 白露未晞 (Lost in Retrospect) 中篇完稿

> **更名通知**：原專案名《惘然》(Wangran) 已正式更名為《白露未晞》(Lost in Retrospect)。
...
## 2026-04-26 — 《半成品》第三章初稿

### HalfFinished

**字數統計（chapter-stats / pure）**
- 總計：17,877 字
- 章數：3 章
- 逐章：01-信 4,842 / 02-到達 4,951 / 03-第一批客人 8,084

**本次完成**
- 新增 `projects/HalfFinished/chapters/03-第一批客人.md`
- 承接第二章結尾的台灣女客人住兩晚，補強「船已開走」與第二天盤點房況後續住的理由
- 補入後院、石階、海灘與朋友介紹此地的背景
- 寫入吵架日本夫妻作為第三章主體
- 植入「還有一位嗎」錯認點
- 植入縁側五分鐘：瑞士刀、対岸の灯台、手背貼臉頰

**注意**
- 本次是在既有 dirty worktree 且目前分支為 `main` 的狀態下補稿；後續正式整理前應先處理分支與同步流程。

---

## 2026-04-26 — 《半成品》結構調整為 20 章

### HalfFinished

**本次調整**
- 將全書結構改為 20 章：春 1-5、夏 6-10、秋 11-15、冬 16-20。
- 更新 `chapter_order.md`：新增 `03-第一位客人.md`、`04-回去.md`、`05-再到.md`，第 6 章改為第二部「夏」開端。
- 更新 `outline.md`：春季改成初次抵達、第一位客人、回台灣、再到；夏季從剩餘訂房尾巴與縁側五分鐘開始。
- 更新 `SPEC.md`、`_CONTEXT.md`、`creative_plan.md`、`agent_guidelines.md`、`the_recurring_guest.md`、`balcony_five_minutes.md`、`misrecognition_map.md` 的章號與縁側五分鐘定位。

**新動機方向**
- 若筠不應直接留島一年；她會先帶骨灰回台灣，處理後事與文件。
- 第二次回島的理由改為房屋遺產責任：估價、關閉或暫停民宿、保險、簡易宿所許可、老屋修繕、颱風季前最低限度安全處理。
- 委託管理可以被提出，但因小島位置、老屋修繕責任、後院安全、颱風巡查、費用高於收益等原因，不足以完全替代她本人到場。

---

## 2026-04-26 — 《半成品》四季回島任務規格統一
...
**本次調整**
- 統一相關規格文件：主線改為「每季回島一週到十天，都是為了讓房子更容易交出去」。
- 修正舊版「長住經營民宿」語感：她會帶骨灰回台灣，也會回到工作崗位；後續回島來自房屋遺產、修繕、管理、出售、封存的現場責任。
- 將夏季第 6-10 章、秋季第 11-15 章、冬季第 16-20 章改為集中式島上任務，不再分散成多次來回。
- 更新語言質地與常客章號：春 1-5、夏 6-10、秋 11-15、冬 16-20；剝橘子對話為第 13 章，哭的場景為第 14 章。
- 同步更新 ISBN 申請資料的簡介與 20 章目次。

---

## 2026-04-26 — 《半成品》第三章重寫為「第一位客人」
...
- 總計：14,420 字
- 章數：3 章
- 逐章：01-信 4,842 / 02-到達 4,951 / 03-第一位客人 4,627

**本次完成**
- 將舊版 `03-第一批客人.md` 移至 `_archives/03-第一批客人.old-20260426.md`。
- 新增 `chapters/03-第一位客人.md`，對齊新版 20 章結構。
- 第三章改為只處理第一位台灣女客：船已開走、不得已留宿、第二天因房屋盤點與文件作業繼續住一晚、第三天退房。
- 移除舊版第三章中的第二組客人、常客錯認、縁側五分鐘與瑞士刀錨點，保留到第 6 章。
- 補入後院、石階、海灘、垃圾分類、辦事處與司法書士來信，讓若筠留下第二晚的動機回到「現場責任」而非經營民宿。

**交接**
- 新增 `projects/HalfFinished/_meta/claude_handoff.md`，記錄目前結構、已完成章節、第三章重寫狀態與第四章下一步方向，供後續 Claude 接手。

---

## 2026-04-26 — 新專案《蘆葦間的風》規劃完成 + 五章 20% 初稿
...
- 副標：蒹葭蒼蒼
- 類型：文學中篇 / 數位靈魂考古 / 婚姻回溯
- 核心：丈夫死後，妻子在他的筆電與 AI 對話 Log 中，讀到一個她共同生活多年卻從未抵達的人。

### 本次完成

- 建立專案規劃骨架：
  - `_meta/creative_plan.md`
  - `_meta/outline.md`
  - `_meta/chapter_order.md`
  - `_meta/agent_guidelines.md`
  - `_meta/planning/ai_log_protocol.md`
  - `_meta/planning/object_map.md`
  - `_characters/character_master.md`
  - `_characters/ling_xu_ming.md`
  - `_characters/wife.md`
- 更新 `_CONTEXT.md` 與 `_meta/story_bible.md`，加入規劃索引與敘事邊界。
- 章節命名定為五章：
  - `01-冷光.md`
  - `02-虛名.md`
  - `03-白露.md`
  - `04-共鳴.md`
  - `05-夜半.md`
- 擴充 `outline.md` 至 v0.2：每章包含章節任務、主要場景、核心物件、女主狀態、可埋線索、禁區、章末位置。
- 完成五章各約 20% 初稿，停在前段轉折，不寫死後段與結尾。

### 目前章節檔案狀態

| 章 | 檔案 | 狀態 | 檔案大小 |
|----|------|------|----------|
| 01 | `01-冷光.md` | 20% 初稿 | 3,843 bytes |
| 02 | `02-虛名.md` | 20% 初稿 | 3,827 bytes |
| 03 | `03-白露.md` | 20% 初稿 | 3,857 bytes |
| 04 | `04-共鳴.md` | 20% 初稿 | 3,614 bytes |
| 05 | `05-夜半.md` | 20% 初稿 | 3,268 bytes |
...
- 已清理章節初稿中的高風險明喻與程度副詞：
  ...
  - 感嘆號
  - 工程化 `[HH:MM]` 時間戳
- 目前 `chapters/` 內上述 grep 檢查無命中。

### 核心寫作邊界

- 不寫成破案。
- 不寫成 AI 戀人。
- AI Log 只作碎片與共鳴，不替男主告白。
- 男主不能被天才化到免除婚姻缺席的責任。
- 女主最後可以理解一部分，但不必原諒。

### 下次 session 可做

1. 補齊待定設定：男女主本名、婚齡、死亡時間與死因、共同生活城市。
2. 逐章從 20% 擴寫到 60%，優先處理第 1-2 章的現實入口與筆名揭露。
3. 補 `_meta/planning/timeline.md`，整理婚姻、發表、死亡、Log 時間線。
4. 做第一輪章節連續性檢查，避免 03:07、舊擺鐘、筆電密碼過早說滿。
